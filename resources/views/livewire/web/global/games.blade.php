<div>
    <div wire:ignore class="flex flex-col max-w-5xl mx-auto">


        <div class="overflow-x-auto min-h-[631px] ">
          <div class="min-w-full inline-block align-middle">
            <div wire:ignore.self data-hs-datatable='{
                "pageLength": 10,
                "pagingOptions": {
            ...
            <div class="relative max-w-xs">
              ...
              <div class="overflow-hidden min-h-[509px] ">
                <table wire:ignore class="min-w-full">
                  ...
                  <tbody class="divide-y divide-gray-200">
                    ...
                    @foreach ($users as $user)
                        <tr>
                            ...
                            <td class="p-3 whitespace-nowrap text-sm text-gray-800">{{ $user['age'] }}</td>
                            <td class="p-3 whitespace-nowrap text-sm text-gray-800">{{ $user['address'] }}</td>
                            <td class="p-3 whitespace-nowrap text-end text-sm font-medium">
                                <button type="button" class="inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent text-blue-600 hover:text-blue-800 focus:outline-none focus:text-blue-800 disabled:opacity-50 disabled:pointer-events-none">update</button>
                            </td>
                        </tr>
                    @endforeach
              ...
              <div wire:ignore class="py-1 px-4" data-hs-datatable-paging="">
                <nav wire:ignore class="flex items-center space-x-1">
                  ...
                  <div wire:ignore class="flex items-center space-x-1 [&>.active]:bg-gray-100" data-hs-datatable-paging-pages=""></div>
                  <button wire:ignore type="button" class="p-2.5 min-w-[40px] inline-flex justify-center items-center gap-x-2 text-sm rounded-full text-gray-800 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 disabled:opacity-50 disabled:pointer-events-none" data-hs-datatable-paging-next="">
        ...
        <div wire:ignore class="mt-20">
            <div wire:ignore id="hs-datatable-with-export" class="flex flex-col --prevent-on-load-init" data-hs-datatable='{
              ...
              "layout": {
                ...
                <div wire:ignore class="flex items-center space-x-2 mb-4">
                  <div class="flex-0">
                    <div class="relative max-w-xs">
                    ...
                    <div wire:ignore id="hs-dropdown-datatable-with-export" class="hs-dropdown [--placement:bottom-right] relative inline-flex">
                      ...
                      <div wire:ignore class="hs-dropdown-menu hs-dropdown-open:opacity-100 w-32 transition-[opacity,margin] duration opacity-0 hidden z-20 bg-white rounded-xl shadow-[0_10px_40px_10px_rgba(0,0,0,0.08)]" role="menu" aria-orientation="vertical" aria-labelledby="hs-datatable-export-dropdown">
                        <div class="p-1 space-y-0.5">
                          ...
                          <button type="button" class="flex w-full items-center gap-x-2 py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-gray-100 focus:outline-none focus:bg-gray-100" data-hs-datatable-action-type="print">
                            <svg class="shrink-0 size-3.5" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        ...
                        <div class="p-1 space-y-0.5 border-t border-gray-200">
                          <button type="button" class="flex w-full items-center gap-x-2 py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-gray-100 focus:outline-none focus:bg-gray-100" data-hs-datatable-action-type="excel">
                          ...
                          <button type="button" class="flex w-full items-center gap-x-2 py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-gray-100 focus:outline-none focus:bg-gray-100" data-hs-datatable-action-type="csv">
                          ...
                          <button type="button" class="flex w-full items-center gap-x-2 py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-gray-100 focus:outline-none focus:bg-gray-100" data-hs-datatable-action-type="pdf">
                      ...
                      <table wire:ignore class="min-w-full">
                        ...
                        <tbody class="divide-y divide-gray-200">
                          ...
                          <tr>
                            ...
                            <td class="p-3 whitespace-nowrap text-sm text-gray-800">2952 S Peoria Ave, Tulsa</td>
                            <td class="p-3 whitespace-nowrap text-end text-sm font-medium">
                              <button type="button" class="inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent text-blue-600 hover:text-blue-800 focus:outline-none focus:text-blue-800 disabled:opacity-50 disabled:pointer-events-none">Delete</button>
                            </td>
                          </tr>
                          ...
                          <tr>
                            ...
                            <td class="p-3 whitespace-nowrap text-sm text-gray-800">255 Dock Ln, New Tazewell</td>
                            <td class="p-3 whitespace-nowrap text-end text-sm font-medium">
                              <button type="button" class="inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent text-blue-600 hover:text-blue-800 focus:outline-none focus:text-blue-800 disabled:opacity-50 disabled:pointer-events-none">Delete</button>
                            </td>
                          </tr>
                          ...
                          <tr>
                            ...
                            <td class="p-3 whitespace-nowrap text-sm text-gray-800">45</td>
                            <td class="p-3 whitespace-nowrap text-sm text-gray-800">4970 Park Ave W, Ohio</td>
                            <td class="p-3 whitespace-nowrap text-end text-sm font-medium">
                              <button type="button" class="inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent text-blue-600 hover:text-blue-800 focus:outline-none focus:text-blue-800 disabled:opacity-50 disabled:pointer-events-none">Delete</button>
                            </td>
                          </tr>
                          ...
                          <tr>
                            ...
                            <td class="p-3 whitespace-nowrap text-sm text-gray-800">45</td>
                            <td class="p-3 whitespace-nowrap text-sm text-gray-800">1818 H St NW, Washington</td>
                            <td class="p-3 whitespace-nowrap text-end text-sm font-medium">
                              <button type="button" class="inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent text-blue-600 hover:text-blue-800 focus:outline-none focus:text-blue-800 disabled:opacity-50 disabled:pointer-events-none">Delete</button>
                            </td>
                          </tr>
                          ...
                          <tr>
                            ...
                            <td class="p-3 whitespace-nowrap text-sm text-gray-800">27</td>
                            <td class="p-3 whitespace-nowrap text-sm text-gray-800">3 Grace Dr, New Mexico</td>
                            <td class="p-3 whitespace-nowrap text-end text-sm font-medium">
                              <button type="button" class="inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent text-blue-600 hover:text-blue-800 focus:outline-none focus:text-blue-800 disabled:opacity-50 disabled:pointer-events-none">Delete</button>
                            </td>
                          </tr>
                          ...
                          <tr>
                            ...
                            <td class="p-3 whitespace-nowrap text-sm text-gray-800">45</td>
                            <td class="p-3 whitespace-nowrap text-sm text-gray-800">4531 W Saile Dr, North Dakota</td>
                            <td class="p-3 whitespace-nowrap text-end text-sm font-medium">
                              <button type="button" class="inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent text-blue-600 hover:text-blue-800 focus:outline-none focus:text-blue-800 disabled:opacity-50 disabled:pointer-events-none">Delete</button>
                            </td>
                          </tr>
                          ...
                          <tr>
                            ...
                            <td class="p-3 whitespace-nowrap text-sm text-gray-800">27</td>
                            <td class="p-3 whitespace-nowrap text-sm text-gray-800">2126 N Eagle, Meridian, Illinois</td>
                            <td class="p-3 whitespace-nowrap text-end text-sm font-medium">
                              <button type="button" class="inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent text-blue-600 hover:text-blue-800 focus:outline-none focus:text-blue-800 disabled:opacity-50 disabled:pointer-events-none">Delete</button>
                            </td>
                          </tr>
                          ...
                          <tr>
                            ...
                            <td class="p-3 whitespace-nowrap text-sm text-gray-800">31</td>
                            <td class="p-3 whitespace-nowrap text-sm text-gray-800">3817 Beryl Rd, Nebraska</td>
                            <td class="p-3 whitespace-nowrap text-end text-sm font-medium">
                              <button type="button" class="inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent text-blue-600 hover:text-blue-800 focus:outline-none focus:text-blue-800 disabled:opacity-50 disabled:pointer-events-none">Delete</button>
                            </td>
                          </tr>
                          ...
                          <tr>
                            ...
                            <td class="p-3 whitespace-nowrap text-sm text-gray-800">27</td>
                            <td class="p-3 whitespace-nowrap text-sm text-gray-800">4807 3rd Ave, New Hampshire</td>
                            <td class="p-3 whitespace-nowrap text-end text-sm font-medium">
                              <button type="button" class="inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent text-blue-600 hover:text-blue-800 focus:outline-none focus:text-blue-800 disabled:opacity-50 disabled:pointer-events-none">Delete</button>
                            </td>
                          </tr>
                          ...
                          <tr>
                            ...
                            <td class="p-3 whitespace-nowrap text-sm text-gray-800">31</td>
                            <td class="p-3 whitespace-nowrap text-sm text-gray-800">Melbourne No. 1 Lake Park</td>
                            <td class="p-3 whitespace-nowrap text-end text-sm font-medium">
                              <button type="button" class="inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent text-blue-600 hover:text-blue-800 focus:outline-none focus:text-blue-800 disabled:opacity-50 disabled:pointer-events-none">Delete</button>
                            </td>
                          </tr>
                          ...
                          <tr>
                            ...
                            <td class="p-3 whitespace-nowrap text-sm text-gray-800">27</td>
                            <td class="p-3 whitespace-nowrap text-sm text-gray-800">New York No. 1 Lake Park</td>
                            <td class="p-3 whitespace-nowrap text-end text-sm font-medium">
                              <button type="button" class="inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent text-blue-600 hover:text-blue-800 focus:outline-none focus:text-blue-800 disabled:opacity-50 disabled:pointer-events-none">Delete</button>
                            </td>
                          </tr>
                          ...
                          <tr>
                            ...
                            <td class="p-3 whitespace-nowrap text-sm text-gray-800">27</td>
                            <td class="p-3 whitespace-nowrap text-sm text-gray-800">LA No. 1 Lake Park</td>
                            <td class="p-3 whitespace-nowrap text-end text-sm font-medium">
                              <button type="button" class="inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent text-blue-600 hover:text-blue-800 focus:outline-none focus:text-blue-800 disabled:opacity-50 disabled:pointer-events-none">Delete</button>
                            </td>
                          </tr>
                          ...
                          <tr>
                            ...
                            <td class="p-3 whitespace-nowrap text-sm text-gray-800">31</td>
                            <td class="p-3 whitespace-nowrap text-sm text-gray-800">Sidney No. 1 Lake Park</td>
                            <td class="p-3 whitespace-nowrap text-end text-sm font-medium">
                              <button type="button" class="inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent text-blue-600 hover:text-blue-800 focus:outline-none focus:text-blue-800 disabled:opacity-50 disabled:pointer-events-none">Delete</button>
                            </td>
                          </tr>
