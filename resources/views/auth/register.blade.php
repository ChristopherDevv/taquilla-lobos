<x-guest-layout>
    <div data-aos="fade-up" data-aos-duration="2000">
        <x-authentication-card titleCard="¡Bienvenido!">
            <x-slot name="logo">
          ...
          {{-- <div class="atropos my-atropos shadow-2xl">
            <div class="atropos-scale scale-100"> <!-- Aumenta o disminuye el valor según prefieras -->
                <div class="atropos-rotate rotate-3"> <!-- Cambia el ángulo de rotación -->
                    <div class="atropos-inner">
                        <img class="rounded-lg w-full h-auto" src="{{ asset('img/img-basketball-1.jpeg') }}" alt="">
                    </div>
                </div>
            </div>
        </div> --}}
